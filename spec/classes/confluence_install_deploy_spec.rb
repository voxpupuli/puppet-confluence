...
describe 'confluence' do
  describe 'confluence::install' do
    ...
    context 'overwriting params' do
      ...
      it { should contain_user('foo').with('home' => '/random/homedir',
                                           'shell' => '/bin/bash',
                                           'uid'   => 333,
                                           'gid'   => 444)
      }
      ...
      it 'should deploy confluence 5.5.5 from tar.gz' do
        should contain_deploy__file('atlassian-confluence-5.5.5.tar.gz').with('url' => 'http://downloads.atlassian.com/',
                                                                              'owner' => 'foo',
                                                                              'group' => 'bar')
      end
